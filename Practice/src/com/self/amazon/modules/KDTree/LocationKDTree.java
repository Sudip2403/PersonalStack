package com.self.amazon.modules.KDTree;
...
class LocationKDTree {
    ...
    public static void main(String[] args) {
    	...
    	LocationKDTree  kdTree = new LocationKDTree(locations);
    	Location loca = kdTree.findNearest(31.2, 24.1);
    	
    	System.out.println(loca.latitude + "/" + loca.longitude);
	}
    
    
    public LocationKDTree(final List<Location> locations) {
        final List<Node> nodes = new ArrayList<Node>(locations.size());
